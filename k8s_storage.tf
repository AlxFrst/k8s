resource "proxmox_vm_qemu" "k8s_storage" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      ...
      "sudo mkdir -p /mnt/nfs-share-session",
      "sudo chown nobody:nogroup /mnt/nfs-share-session",
      "sudo chmod 777 /mnt/nfs-share-session",
      "echo '/mnt/nfs-share-session 192.168.1.0/24(rw,sync,no_subtree_check,no_root_squash)' | sudo tee -a /etc/exports",
      "sudo exportfs -a",
